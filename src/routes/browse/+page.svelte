<script lang="ts">
  ...
  import PinFeaturedButton from '$lib/components/PinFeaturedButton.svelte';
    ...
    {#each filteredPuzzles as puzzle}
      <div class="overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm transition hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div class="p-6">
          ...
          <p class="[WebkitLineClamp:2] [WebkitBoxOrient:vertical] mb-4 [display:-webkit-box] overflow-hidden text-sm text-zinc-600 dark:text-zinc-400">
            {puzzle.description}
          </p>
