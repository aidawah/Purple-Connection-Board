...
<!-- Desktop navbar -->
<nav
	class="sticky top-0 z-50 hidden border-b border-gray-200 bg-white md:block dark:border-zinc-800 dark:bg-zinc-900"
>
	<div class="relative flex items-center justify-between px-4 py-3">
		...
		<a href="/" class="group flex items-center space-x-2">
			...
			<span
				class="text-xl font-semibold text-teal-600 transition-colors group-hover:text-teal-700 dark:text-teal-400 dark:group-hover:text-teal-300"
			>
				Purple Connections
			</span>
		</a>
		...
		<div class="absolute left-1/2 -translate-x-1/2">
			<ul class="flex list-none items-center gap-6 text-sm font-medium">
                ...
                ${
									...
									($page.url.pathname.startsWith('/gameboard') && it.href === '/')
										? 'bg-teal-50 font-semibold text-teal-700 dark:bg-teal-900/40 dark:text-teal-300'
		...
		<div class="relative flex-shrink-0">
			{#if userData.email}
				...
				<button
					type="button"
					class="flex h-10 w-10 items-center justify-center rounded-full bg-teal-600 text-white
                 focus:ring-4 focus:ring-teal-300 focus:outline-none dark:focus:ring-teal-700"
					aria-haspopup="true"
				...
				>
					...
					{#if userData.photoURL}
						<img src={userData.photoURL} alt="Profile" class="h-8 w-8 rounded-full object-cover" />
					{:else}
						<span class="grid h-8 w-8 place-items-center rounded-full font-semibold select-none">
				...
				{#if showUserMenu}
					<div
						...
						class="absolute right-0 z-50 mt-2 w-56 divide-y divide-gray-100 rounded-lg bg-white
                   shadow-lg dark:divide-gray-600 dark:bg-gray-700"
					>
						<div class="px-4 py-3">
						...
						<div class="px-3 pt-2 pb-3">
							<div class="mb-2 text-xs font-medium text-zinc-500 dark:text-zinc-400">Theme</div>
							<div role="group" aria-label="Theme" class="grid grid-cols-3 gap-2">
								<button
									class={`flex h-9 items-center justify-center gap-2 rounded-lg border transition
                    ${
											themeMode === 'light'
												? 'border-teal-600 bg-teal-600 text-white'
												: 'border-zinc-300 bg-white text-zinc-700 hover:border-teal-400 hover:text-teal-700 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:border-teal-500'
										}`}
								...
								>
									...
									<svg
										...
										fill="currentColor"
										><path
											d="M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.8 1.42-1.42zm10.48 0l1.79-1.8 1.41 1.41-1.8 1.79-1.4-1.4zM12 4h0V1h0v3zm0 19h0v-3h0v3zM4 12H1v0h3zm22 0h-3v0h3zM6.76 19.16l-1.42 1.42-1.79-1.8 1.41-1.41 1.8 1.79zm13.69-.38l-1.41 1.41-1.79-1.8 1.41-1.41 1.79 1.8zM12 8a4 4 0 100 8 4 4 0 000-8z"
										/></svg
									>
								</button>
                    ...
                    ${
								...
								>
									...
									<svg
										...
										fill="currentColor"
										><path
											d="M20 3H4a2 2 0 00-2 2v10a2 2 0 002 2h6v2H8v2h8v-2h-2v-2h6a2 2 0 002-2V5a2 2 0 00-2-2zm0 12H4V5h16v10z"
										/></svg
									>
								</button>
							</div>
						...
						<ul class="py-2">
                         ...
                         dark:text-gray-200 dark:hover:bg-teal-600/30 dark:hover:text-white"
							...
							<li>
								<button
									class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700
                         dark:text-gray-200 dark:hover:bg-teal-600/30 dark:hover:text-white"
			...
			{:else}
				...
				<button
                 ...
                 hover:bg-teal-700 focus:ring-4 focus:ring-teal-300 focus:outline-none
...
<!-- Mobile bottom nav -->
<nav
	class="fixed inset-x-0 bottom-0 z-50 border-t
				...
				<li class="flex">
                    ...
                    ${
											$page.url.pathname === it.href
												...
												: 'text-zinc-300 hover:bg-neutral-800/70 hover:text-teal-300'
										}`}
					>
						<span class="text-center leading-tight">{it.label}</span>
					</a>
				</li>
			{/each}
			<li class="flex">
				<button
                  ...
                  transition-[background,color,transform] duration-150 focus:outline-none
                  focus-visible:ring-2 focus-visible:ring-teal-500/60 active:scale-[0.98]
                  ${
										userData.email
											? 'text-zinc-300 hover:bg-neutral-800/70 hover:text-teal-300'
