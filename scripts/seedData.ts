...
export const seedPuzzles = [
	{
		...
		categories: [
			...
			{
				title: 'Tennis Slams',
				words: ['Wimbledon', 'US Open', 'Roland Garros', 'Australian Open']
			},
	...
	},
	{
		...
		categories: [
			{ title: 'NBA Legends', words: ['Jordan', 'LeBron', 'Kobe', 'Magic', 'Bird'] },
			{
				...
				words: ['Striker', 'Winger', 'Keeper', 'Fullback', 'Midfielder']
			},
			{ title: 'Tennis Strokes', words: ['Forehand', 'Backhand', 'Serve', 'Slice', 'Dropshot'] },
			{
				title: 'Pitch Types',
				words: ['Fastball', 'Curveball', 'Slider', 'Changeup', 'Knuckleball']
			},
