	...
	categories: Joi.array()
		.items(
			Joi.object({
				...
				words: Joi.array().items(Joi.string().min(1).max(25)).length(4).required(),
...
_This document is a living specification and will be updated as the application evolves. All changes require review and approval from the development team._
